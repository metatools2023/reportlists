...
- 站点：<https://reportlists.pages.dev> · 数据洞察（统计页）：<https://reportlists.pages.dev/stats>
...
M3 统计页已上线（2026-09-02）：数据挖掘四方向——卖方情绪指数 / 行业热度热力图 / 标题热词词云 / 机构·研究员画像，`build_stats.py` 已挂入每日管道自动更新；SEO sitemap 待开发。
